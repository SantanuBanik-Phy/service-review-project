    ...
    return (
        <div className="hero min-h-screen bg-gradient-to-br from-gray-200 via-white to-gray-300 flex flex-col items-center justify-center text-center">
            ...
            <div className="max-w-lg">
                ...
                <Link
                    to="/"
                    className="mt-4 inline-block px-6 py-3 bg-gradient-to-r from-green-500 to-green-700 text-white font-semibold text-lg rounded-lg shadow-lg hover:from-green-600 hover:to-green-800 transition-all duration-300"
                >
                    Go Back Home
                </Link>
            </div>
