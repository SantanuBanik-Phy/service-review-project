...
const Services = () => {
  ...
  const [sort, setSort] = useState(''); // For sorting by price
  ...
  const sortedServices = [...services]; // Clone the services array
  if (sort === 'asc') {
    sortedServices.sort((a, b) => a.price - b.price); // Sort by price ascending
  } else if (sort === 'desc') {
    sortedServices.sort((a, b) => b.price - a.price); // Sort by price descending
  }
